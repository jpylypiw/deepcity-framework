# Contributing
Thank you for your interest in contributing to deepcity-framework - but to keep everything organized, we need some guidelines and standards that apply to the project.
...
## Code of conduct
Please refer to our [code of conduct](https://github.com/Eukalyptus-Dreizack/deepcity-framework/blob/develop/CODE_OF_CONDUCT.md) before you contribute anything as it sets 
...
### Security issues
If you find some really serious security issue, please don't create a GitHub issue for it in the first line - it could put all bots based on this framework onto risk.
...
As a first time contributor, you might find it hard to find an issue that you can work on. To make it easier for you, some issues will be labeled as "C4 - good first issue".
...
The step by step process for code contributions to deepcity-framework looks like the following:
